...
function EventCard(
  ...
  return (
    <div>
      <div className="bg-white shadow-lg rounded-lg p-6 w-sm h-fit cursor-pointer mt-10 hover:mt-4 hover:shadow-2xl transition-all duration-200" onClick={handleClick}>
